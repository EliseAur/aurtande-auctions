...
export async function setCreateBidFormListener() {
  ...
  bidForm.addEventListener("submit", async (event) => {
    ...
    try {
      ...
      console.log("biddata.amount", bidData.amount);

      const listing = await listingMethods.getListing(listingId);
      console.log("I bid on this listing", listing);
      ...
      if (listing.bids.length === 0) {
        ...
        console.log("LastBidInListing", lastBidInListing);
      } else {
        lastBidInListing = listing.bids[indexLastBid];
        console.log("LastBidInListing", lastBidInListing.bidderName);
      }

      const seller = listing.seller.name;
      console.log("listing.seller.name:", seller);
...
//         // Set a default value when there are no bids
//         lastBidInListing = { bidderName: "No bids yet" };
//         console.log(lastBidInListing);
//       } else {
//         lastBidInListing = listing.bids[indexLastBid];
//         console.log("lastBidder", lastBidInListing.bidderName);
//       }
...
//       } else {
//         alert(
//           "Sorry, you can not place this bid. You are either on top of the bidding list, you don't have enough credits or you created this bid.",
//         );
//       }
//     } catch (error) {
//       console.error("Error occurred while creating bid:", error);
